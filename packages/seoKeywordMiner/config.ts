...
export default defineTool({
  ...
  description: {
    ...
    en: "Massive long-tail keyword mining tool based on 5118 API, get keyword search volume and index data",
  },
  toolDescription:
      ...
      inputs: [
        ...
        },
        {
          ...
          toolDescription:
            "排序字段(2:竞价公司数量,3:长尾词数量,4:流量指数,5:百度移动指数,6:360好搜指数,7:PC日检索量,8:移动日检索量,9:竞争激烈程度)",
          list: [
            { label: "竞价公司数量", value: "2" },
            { label: "长尾词数量", value: "3" },
            { label: "流量指数", value: "4" },
            { label: "百度移动指数", value: "5" },
            { label: "360好搜指数", value: "6" },
            { label: "PC日检索量", value: "7" },
            { label: "移动日检索量", value: "8" },
            { label: "竞争激烈程度", value: "9" },
          ],
        },
        {
          key: "sortType",
        ...
        },
        {
          ...
          list: [
            ...
            { label: "流量指数词", value: "3" },
            { label: "移动指数词", value: "4" },
            { label: "360指数词", value: "5" },
            { label: "流量特点词", value: "6" },
            { label: "PC日检索量词", value: "7" },
            { label: "移动日检索量", value: "8" },
            { label: "存在竞价的词", value: "9" },
          ],
        },
        {
          key: "filterDate",
