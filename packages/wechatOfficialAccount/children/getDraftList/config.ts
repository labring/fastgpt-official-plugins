      ...
      inputs: [
        {
          ...
          label: "访问令牌",
          description:
            "微信公众号 API 访问令牌（可选，与 appId/secret 二选一）",
          renderTypeList: [
        ...
        },
        {
          ...
          label: "AppID",
          description:
            "微信公众号 AppID（与 secret 配合使用，或使用 accessToken）",
          renderTypeList: [
            FlowNodeInputTypeEnum.input,
            FlowNodeInputTypeEnum.reference,
          ],
        ...
        },
        {
          ...
          label: "AppSecret",
          description:
            "微信公众号 AppSecret（与 appId 配合使用，或使用 accessToken）",
          renderTypeList: [
            FlowNodeInputTypeEnum.input,
            FlowNodeInputTypeEnum.reference,
          ],
        ...
        },
        {
          ...
          label: "偏移量",
          description:
            "从全部素材的该偏移位置开始返回，0 表示从第一个素材返回，默认为 0",
          renderTypeList: [
            FlowNodeInputTypeEnum.input,
            FlowNodeInputTypeEnum.reference,
          ],
          ...
          required: false,
          toolDescription:
            "offset for pagination, 0 means start from the first item",
        },
        {
          key: "count",
          label: "返回数量",
        ...
        },
        {
          ...
          label: "不返回内容",
          description:
            "是否不返回文章内容字段，1 表示不返回，0 表示返回，默认为 0",
          renderTypeList: [
            FlowNodeInputTypeEnum.input,
            FlowNodeInputTypeEnum.reference,
          ],
          ...
          required: false,
          toolDescription:
            "1 means no content field returned, 0 means content field returned",
        },
      ],
      outputs: [
        {
