...
import z from 'zod';
import { InputType as metasoSearchInputType, OutputType as metasoSearchOutputType, tool as metasoSearchTool } from './children/metasoSearch';
...
const metasoSearchInputSchema = z.object({
  ...
  "scope": z.enum(["all","webpage","document","scholar","image","video","podcast"]).optional().meta({
    title: "搜索范围",
